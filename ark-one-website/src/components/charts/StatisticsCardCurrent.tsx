        ...
        <Grid container spacing={1}>
          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 1.25, borderRadius: 2, background: 'linear-gradient(90deg,#fff7ed,#fff4e6)', border: '1px solid rgba(248,87,0,0.08)' }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333' }}>{(statistics.MeanCurrents ?? 0).toFixed(2)} A</Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 1.25, borderRadius: 2, background: 'linear-gradient(90deg,#f0f8ff,#eef7ff)', border: '1px solid rgba(30,136,229,0.06)' }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333' }}>{(statistics.MedianCurrents ?? 0).toFixed(2)} A</Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 1.25, borderRadius: 2, background: 'linear-gradient(90deg,#fff8e1,#fff4d6)', border: '1px solid rgba(255,193,7,0.06)' }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333' }}>{(statistics.SDCurrent ?? 0).toFixed(2)}</Typography>
            </Box>
          </Grid>

          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 1.25, borderRadius: 2, background: 'linear-gradient(90deg,#fff0f6,#fff2f4)', border: '1px solid rgba(233,30,99,0.04)' }}>
              <Typography variant="caption" sx={{ color: '#d81b60', fontWeight: 600 }}>Assimetria</Typography>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333' }}>{(statistics.SkewnessCurrents ?? 0).toFixed(2)}</Typography>
            </Box>
          </Grid>

          <Grid item xs={12}>
            <Box sx={{ mt: 1.25, p: 1.25, borderRadius: 2, background: 'linear-gradient(90deg,#ffffff,#fafafa)', border: '1px solid rgba(0,0,0,0.03)' }}>
              <Typography variant="caption" sx={{ color: '#555', fontWeight: 600 }}>Média de Potência</Typography>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333' }}>{(statistics.MeanWattage ?? 0).toFixed(2)} W</Typography>
            </Box>
          </Grid>
        </Grid>
       ) : (
