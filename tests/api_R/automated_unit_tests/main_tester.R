setwd("/home/white/Programs/Github/ARK_ONE/tests/api_R")

source("automated_unit_tests/test_endpoint_account.R", chdir = TRUE)
source("automated_unit_tests/test_endpoint_products.R", chdir = TRUE)
